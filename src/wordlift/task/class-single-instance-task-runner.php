<?php
/**
 * This file defines the Wordlift_Single_Instance_Task_Runner class
 * and the Wordlift_Another_Instance_Is_Running_Exception exception.
 *
 * The single runner executes a non-concurrent {@link Wordlift_Task}
 * ensuring that only one instance of this task is executed. It does so by using WordPress
 * transients.
 *
 * This file is part of the task subfolder.
 *
 * @since 1.0.0
 ...
 * @since 1.0.0
 */
class Single_Instance_Task_Runner {
	 ...
	 * @since 1.0.0
	 */
	const IS_RUNNING_PREFIX = '_wltask_single_instance_task_runner__';
	...
	/**
	 * The {@link Wordlift_Task} to execute.
	 *
	 * @since 1.0.0
	 * @var Task $task The {@link Wordlift_Task} to execute.
	 * @access private
	 */
	private $task;
	 ...
	 *
	 * @since 1.0.0
	 * @var Progress[] $callbacks An array of {@link Wordlift_Progress}.
	 * @access private
	 */
	private $callbacks;
	...
	/**
	 * Create a {@link Wordlift_Single_Instance_Task_Runner} instance.
	 *
	 * @param Task $task The {@link Wordlift_Task} instance.
	 * @param bool                                    $force Whether to force starting a task even if another instance of the task is already running, default `false`.
	 * @param array                                   $callbacks An array of {@link Wordlift_Progress}.
	 *
	 * @since 1.0.0
	 */
	 ...
	 *
	 * @throws Another_Instance_Is_Running_Exception if the task is already running.
	 * @since 1.0.0
	 */
	public function start( $limit = 0, $offset = 0 ) {
		...
		if ( ! $this->force && $this->is_running() ) {
			throw new Another_Instance_Is_Running_Exception();
		}
